!(function () {
    ...
    x =
      ...
      (function (t) {
        ...
        function n() {
          ...
          return (
            e(this, n),
            (t = i.call(this, r)).resetNativeScroll &&
          ...
          r(n, [
            {
              ...
              value: function () {
                (this.instance.scroll.y = window.pageYOffset),
                  this.addElements(),
                  this.detectElements(),
                  f(l(n.prototype), "init", this).call(this);
              },
            },
            {
              key: "checkScroll",
              value: function () {
                var t = this;
                f(l(n.prototype), "checkScroll", this).call(this),
            ...
            },
            {
              key: "destroy",
              value: function () {
                f(l(n.prototype), "destroy", this).call(this),
  ...
  var it = function (t, e, i, r) {
      ...
      for (var n = K ? new Float32Array(11) : new Array(11), s = 0; s < 11; ++s)
        n[s] = J(s * U, t, i);
      function o(e) {
        for (var r = 0, s = 1; 10 !== s && n[s] <= e; ++s) r += U;
        --s;
        var o = r + ((e - n[s]) / (n[s + 1] - n[s])) * U,
          a = tt(o, t, i);
        return a >= 0.001
          ? (function (t, e, i, r) {
              for (var n = 0; n < 4; ++n) {
    ...
    ht = (function (t) {
      ...
      function n() {
        ...
        return (
          ...
          window.scrollTo(0, 0),
          (t = i.call(this, r)).inertia && (t.lerp = 0.1 * t.inertia),
          (t.isScrolling = !1),
        ...
        r(n, [
                    ...
                    var r,
                      ...
                      _ = (s =
                        void 0 !== y
                          ...
                          : e).getBoundingClientRect();
                    null === a || a.inView
                      ? ((r = _.top + t.instance.scroll.y - X(s).y),
                        (n = _.left + t.instance.scroll.x - X(s).x))
                      : ((r = _.top - X(a.el).y - X(s).y),
                        (n = _.left - X(a.el).x - X(s).x));
                    var w = r + s.offsetHeight,
                      b = n + s.offsetWidth,
                      x = { x: (b - n) / 2 + n, y: (w - r) / 2 + r };
                    if (g) {
                      ...
                      if ("horizontal" === t.direction) {
                        ...
                        for (A = 0; A < v.length; A++)
                          "string" == typeof v[A]
                            ? v[A].includes("%")
                              ? (S[A] = parseInt(
                                  (v[A].replace("%", "") * t.windowHeight) / 100
                                ))
                              : (S[A] = parseInt(v[A]))
                            : (S[A] = v[A]);
                        (r += S[0]), (w -= S[1]);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (((s = it.apply(void 0, D(s))), "string" == typeof t)) {
                if ("top" === t) t = 0;
              ...
              if ("number" != typeof t) {
                ...
                var u = t.getBoundingClientRect(),
                  ...
                  g = 0;
                (g = f
                  ? X(f)[this.directionAxis]
                  : -this.instance.scroll[this.directionAxis]),
                  (r = "horizontal" === this.direction ? h + r - g : c + r - g);
              } else r = t + r;
                ...
                b = function t() {
                  ...
                  i > 1
                    ? (_(1),
                      ...
                      0 == n && e.update(),
                      a && a())
                    : ((e.scrollToRaf = requestAnimationFrame(t)), _(s(i)));
                };
              b();
            },
          },
  ...
  (mt.prototype.setup = function () {
    ...
    (mt.prototype.add = function () {
      this.wrap.insertAdjacentHTML("beforeend", this.properties.view.outerHTML);
    }),
    (mt.prototype.update = function () {
      document.title = this.properties.page.title;
    }),
    (mt.prototype.show = function (t) {
      var e = this;
  ...
  (yt.prototype.getOrigin = function (t) {
    ...
    (yt.prototype.getPathname = function (t) {
      var e = t.match(/https?:\/\/.*?(\/[\w_\-./]+)/);
      return e ? e[1] : "/";
    }),
    (yt.prototype.getAnchor = function (t) {
      var e = t.match(/(#.*)$/);
      return e ? e[1] : null;
    }),
    (yt.prototype.getParams = function (t) {
      var e = t.match(/\?([\w_\-.=&]+)/);
      if (!e) return null;
    ...
    (yt.prototype.getDOM = function (t) {
      return "string" == typeof t ? vt.parseFromString(t, "text/html") : t;
    }),
    (yt.prototype.getView = function (t) {
      return t.querySelector("[data-router-view]");
    }),
    (yt.prototype.getSlug = function (t) {
      return t.getAttribute("data-router-view");
    }),
    (yt.prototype.getRenderer = function (t) {
      if (!this.renderers) return Promise.resolve(mt);
      if (t in this.renderers) {
        var e = this.renderers[t];
        return "function" != typeof e || mt.isPrototypeOf(e)
    ...
    (yt.prototype.getTransition = function (t) {
    ...
    (yt.prototype.getProperties = function (t) {
      var e = this.getDOM(t),
        i = this.getView(e),
        r = this.getSlug(i);
      return {
    ...
    (yt.prototype.getLocation = function (t) {
      return {
        href: t,
  ...
  var bt = { Core: _t, Helpers: yt, Renderer: mt, Transition: wt };
  function xt(t) {
    if (void 0 === t)
      throw new ReferenceError(
        "this hasn't been initialised - super() hasn't been called"
   ...
   */ var Et,
    ...
    te = { duration: 0.5, overwrite: !1, delay: 0 },
    ee = 1e8,
    ie = 1e-8,
    re = 2 * Math.PI,
    ne = re / 4,
    ...
    Ve = function (t) {
      var e,
        i,
        r = t[0];
      if ((fe(r) || ce(r) || (t = [t]), !(e = (r._gsap || {}).harness))) {
        for (i = ze.length; i-- && !ze[i].targetTest(r); );
        e = ze[i];
      }
      for (i = t.length; i--; )
        (t[i] && (t[i]._gsap || (t[i]._gsap = new ur(t[i], e)))) ||
          t.splice(i, 1);
      return t;
    },
    He = function (t) {
      return t._gsap || Ve(Si(t))[0]._gsap;
    },
    We = function (t, e, i) {
      return (i = t[e]) && ce(i)
        ? t[e]()
        : (de(i) && t.getAttribute && t.getAttribute(e)) || i;
    },
    Ne = function (t, e) {
    ...
    Ge = function (t, e, i) {
      ...
      if ((n && (o.duration = t[1]), (o.parent = i), e)) {
        for (r = o; i && !("immediateRender" in r); )
          (r = i.vars.defaults || {}), (i = pe(i.vars.inherit) && i.parent);
        (o.immediateRender = pe(r.immediateRender)),
    ...
    Ue = function () {
      var t,
        ...
        i = Le.length,
        r = Le.slice(0);
      for (Pe = {}, Le.length = 0, t = 0; t < i; t++)
        (e = r[t]) &&
          e._lazy &&
          (e.render(e._lazy[0], e._lazy[1], !0)._lazy = 0);
    },
    Ke = function (t, e, i, r) {
      Le.length && Ue(), t.render(e, i, r), Le.length && Ue();
    },
    $e = function (t) {
      var e = parseFloat(t);
    ...
    pi = function (t, e) {
      ...
      if (
        ((e._time || (e._initted && !e._dur)) &&
          ((i = hi(t.rawTime(), e)),
          (!e._dur || Ci(0, e.totalDuration(), i) - e._tTime > ie) &&
            e.render(i, !0)),
    ...
    gi = function (t, e) {
      return (
        (Fe.ScrollTrigger || Ae("scrollTrigger", e)) &&
    ...
    yi = function (t, e, i, r) {
      ...
      return (
        ...
        (t._dur = s),
        (t._tDur = n ? (n < 0 ? 1e10 : Ye(s * (n + 1) + t._rDelay * n)) : s),
        o && !r ? fi(t, (t._tTime = t._tDur * o)) : t.parent && di(t),
        i || oi(t.parent, t),
        t
      );
    },
    _i = function (t) {
      return t instanceof hr ? oi(t) : yi(t, t._dur);
    },
    wi = { _start: 0, endTime: Me },
    bi = function t(e, i) {
      var r,
        n,
        s = e.labels,
        o = e._recent || wi,
        a = e.duration() >= ee ? o.endTime(!1) : e._dur;
      return ue(i) && (isNaN(i) || i in s)
        ? "<" === (r = i.charAt(0)) || ">" === r
    ...
    Ti = function (t, e) {
      return (
        ...
        fe(t) &&
        "length" in t &&
        ((!e && !t.length) || (t.length - 1 in t && fe(t[0]))) &&
        !t.nodeType &&
        t !== Tt
      );
    },
    Si = function (t, e) {
      return !ue(t) || e || (!St && Qi())
        ? ve(t)
          ? (function (t, e, i) {
              return (
                ...
                t.forEach(function (t) {
                  var r;
                  return (ue(t) && !e) || Ti(t, 1)
                    ? (r = i).push.apply(r, Si(t))
                    : i.push(t);
                }) || i
              );
            })(t, e)
          ...
          ? [t]
          : []
        : Fi.call(At.querySelectorAll(t), 0);
    },
    Ai = function (t) {
      ...
      return (
        ...
        function (t, o, h) {
          var d,
            ...
            b = s[w];
          if (!b) {
            if (!(_ = "auto" === e.grid ? 0 : (e.grid || [1, ee])[1])) {
              for (
                v = -1e8;
    ...
    Bi = function (t, e, i, r) {
      return xi(ve(t) ? !e : !0 === i ? !!(i = 0) : !r, function () {
        return ve(t)
    ...
    Pi = function (t) {
      for (var e, i, r, n, s = 0, o = ""; ~(e = t.indexOf("random(", s)); )
        (r = t.indexOf(")", e)),
          (n = "[" === t.charAt(e + 7)),
          (i = t.substr(e + 7, r - e - 7).match(n ? Ce : ye)),
          (o +=
            t.substr(s, e - s) +
            Bi(n ? i : +i[0], n ? 0 : +i[1], +i[2] || 1e-5)),
          (s = r + 1);
    ...
    Ii = function (t) {
      ...
      if ((Qi(), t !== r)) {
        if (je[e]) return;
        Ze(r, Ze(ii(t, n), s)),
          ti(r.prototype, ti(n, ii(t, s))),
          (je[(r.prop = e)] = r),
          t.targetTest && (ze.push(r), (Be[e] = 1)),
          (e =
            ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) +
            "Plugin");
      }
      Oe(e, r), t.register && t.register(qr, r, Lr);
    },
    Vi = 255,
    Hi = {
      aqua: [0, Vi, Vi],
    ...
    Ni = function (t, e, i) {
      var r,
        ...
        h,
        d,
        f = t ? (he(t) ? [t >> 16, (t >> 8) & Vi, t & Vi] : 0) : Hi.black;
      if (!f) {
        if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Hi[t]))
          f = Hi[t];
        else if ("#" === t.charAt(0)) {
          if (
            (t.length < 6 &&
          ...
          f = [(t = parseInt(t.substr(1), 16)) >> 16, (t >> 8) & Vi, t & Vi];
        } else if ("hsl" === t.substr(0, 3))
          if (((f = d = t.match(ye)), e)) {
            if (~t.indexOf("="))
              return (f = t.match(_e)), i && f.length < 4 && (f[3] = 1), f;
          } else
            (o = (+f[0] % 360) / 360),
              (a = +f[1] / 100),
              (r =
              ...
              (f[1] = Wi(o, r, n)),
              (f[2] = Wi(o - 1 / 3, r, n));
        else f = t.match(ye) || Hi.transparent;
        f = f.map(Number);
      }
      return (
        e &&
    ...
    Xi = function (t, e, i) {
      ...
      if (
        ...
        i && ((s = Yi(t)), (r = i.c).join(a) !== s.c.join(a)))
      )
        for (o = (n = t.replace(Gi, "1").split(we)).length - 1; c < o; c++)
          a +=
            n[c] +
            (~r.indexOf(c)
              ? l.shift() || u + "0,0,0,0)"
      ...
      if (!n)
        for (o = (n = t.split(Gi)).length - 1; c < o; c++) a += n[c] + l[c];
      return a + n[o];
    },
    Gi = (function () {
      var t,
    ...
    $i =
      ...
      (Ut = function t(e) {
        ...
        if (
          ...
          for (zt = 0; zt < Gt.length; zt++) Gt[zt](n, qt, s, e);
      }),
      (Rt = {
        time: 0,
        frame: 0,
        ...
        wake: function () {
          kt &&
            (!St &&
              ...
              (At = Tt.document || {}),
              (Fe.gsap = qr),
              (Tt.gsapVersions || (Tt.gsapVersions = [])).push(qr.version),
              Se(Te || Tt.GreenSockGlobals || (!Tt.gsap && Tt) || {}),
              (jt = Tt.requestAnimationFrame)),
            Lt && Rt.sleep(),
            (Pt =
              jt ||
              function (t) {
                return setTimeout(t, (Xt - 1e3 * Rt.time + 1) | 0);
              }),
            (Bt = 1),
            Ut(2));
        },
        sleep: function () {
          (jt ? Tt.cancelAnimationFrame : clearTimeout)(Lt),
            (Bt = 0),
            (Pt = Me);
        },
        lagSmoothing: function (t, e) {
          (Vt = t || 1e8), (Ht = Math.min(e, Vt, 0));
        },
        fps: function (t) {
          (Yt = 1e3 / (t || 240)), (Xt = 1e3 * Rt.time + Yt);
        },
        add: function (t) {
          Gt.indexOf(t) < 0 && Gt.push(t), Qi();
        },
        remove: function (t) {
          var e;
          ~(e = Gt.indexOf(t)) && Gt.splice(e, 1) && zt >= e && zt--;
        },
        _listeners: (Gt = []),
      })),
    Qi = function () {
    ...
    er = function (t) {
      for (
        ...
        (i = s[a]),
          ...
          (r = i.substr(0, e)),
          (n[o] = isNaN(r) ? r.replace(tr, "").trim() : +r),
          (o = i.substr(e + 1).trim());
      return n;
    },
    ir = function (t) {
    ...
    sr = function (t, e, i, r) {
      ...
      return (
        Ne(t, function (t) {
          for (var e in ((Zi[t] = Fe[t] = s),
          (Zi[(n = t.toLowerCase())] = i),
          s))
            Zi[
    ...
    ar = function t(e, i, r) {
      var n = i >= 1 ? i : 1,
        ...
        o = (s / re) * (Math.asin(1 / n) || 0),
        a = function (t) {
          return 1 === t ? 1 : n * Math.pow(2, -10 * t) * le((t - o) * s) + 1;
        },
        l =
          "out" === e
            ? a
  ...
  Ne("Linear,Quad,Cubic,Quart,Quint,Strong", function (t, e) {
    ...
    (Zi.Linear.easeNone = Zi.none = Zi.Linear.easeIn),
    sr("Elastic", ar("in"), ar("out"), ar()),
    (Kt = 7.5625),
    (Qt = 1 / ($t = 2.75)),
    sr(
      "Bounce",
      ...
      (Zt = function (t) {
        return t < Qt
          ...
          ? Kt * Math.pow(t - 1.5 / $t, 2) + 0.75
          : t < 0.9090909090909092
          ? Kt * (t -= 2.25 / $t) * t + 0.9375
          : Kt * Math.pow(t - 2.625 / $t, 2) + 0.984375;
      })
    ),
    sr("Expo", function (t) {
    ...
    sr("Sine", function (t) {
      return 1 === t ? 1 : 1 - ae(t * ne);
    }),
    sr("Back", lr("in"), lr("out"), lr()),
    (Zi.SteppedEase =
      Zi.steps =
      Fe.SteppedEase =
        {
          config: function (t, e) {
            ...
            var i = 1 / t,
              ...
              n = e ? 1 : 0;
            return function (t) {
              return (((r * Ci(0, 0.99999999, t)) | 0) + n) * i;
            };
          },
        }),
    (te.ease = Zi["quad.out"]),
    ...
    cr = (function () {
      function t(t, e) {
        ...
        (this.vars = t),
          ...
          (this._ts = 1),
          yi(this, +t.duration, 1, 1),
          (this.data = t.data),
          Bt || $i.wake(),
          i && Di(i, this, e || 0 === e ? e : i._time, 1),
      ...
      return (
        ...
        (e.totalTime = function (t, e) {
          if ((Qi(), !arguments.length)) return this._tTime;
          var i = this._dp;
          if (i && i.smoothChildTiming && this._ts) {
            for (fi(this, t), !i._dp || i.parent || pi(i, this); i.parent; )
              i.parent._time !==
                i._start +
                  (i._ts >= 0
                    ? i._tTime / i._ts
          ...
          return (
            (this._tTime !== t ||
              ...
              (this._ts || (this._pTime = t), Ke(this, t, e)),
            this
          );
        }),
        (e.time = function (t, e) {
          return arguments.length
            ? this.totalTime(
                Math.min(this.totalDuration(), t + ui(this)) % this._dur ||
                  (t ? this._dur : 0),
                e
              )
            : this._time;
        ...
        (e.timeScale = function (t) {
          ...
          var e =
            this.parent && this._ts ? hi(this.parent._time, this) : this._tTime;
          return (
            (this._rts = +t || 0),
            (this._ts = this._ps || -1e-8 === t ? 0 : this._rts),
            ai(this.totalTime(Ci(-this._delay, this._tDur, e), !0))
          );
        }),
        (e.paused = function (t) {
          return arguments.length
        ...
        (e.startTime = function (t) {
          if (arguments.length) {
            ...
            return (
              e && (e._sort || !this.parent) && Di(e, this, t - this._delay),
              this
            );
          }
          return this._start;
        ...
        (e.repeat = function (t) {
          return arguments.length
            ? ((this._repeat = t === 1 / 0 ? -2 : t), _i(this))
            : -2 === this._repeat
            ? 1 / 0
            : this._repeat;
        }),
        ...
        (e.seek = function (t, e) {
          return this.totalTime(bi(this, t), pe(e));
        }),
        (e.restart = function (t, e) {
          return this.play().totalTime(t ? -this._delay : 0, pe(e));
        }),
        (e.play = function (t, e) {
          ...
          return new Promise(function (i) {
            var r = ce(t) ? t : Qe,
              n = function () {
                var t = e.then;
                (e.then = null),
                  ce(r) && (r = r(e)) && (r.then || r === e) && (e.then = t),
                  i(r),
                  (e.then = t);
              };
  ...
  var hr = (function (t) {
    function e(e, i) {
      ...
      return (
        ...
        (r._sort = pe(e.sortChildren)),
        r.parent && pi(r.parent, xt(r)),
        e.scrollTrigger && gi(xt(r), e.scrollTrigger),
        r
      );
    }
    Ct(e, t);
    ...
    return (
      (i.to = function (t, e, i) {
        return (
          new _r(t, Ge(arguments, 0, this), bi(this, he(e) ? arguments[3] : i)),
          this
        );
      }),
      (i.from = function (t, e, i) {
        return (
          new _r(t, Ge(arguments, 1, this), bi(this, he(e) ? arguments[3] : i)),
          this
        );
      }),
      (i.fromTo = function (t, e, i, r) {
        return (
          new _r(t, Ge(arguments, 2, this), bi(this, he(e) ? arguments[4] : r)),
          this
        );
      }),
      (i.set = function (t, e, i) {
        return (
          (e.duration = 0),
          (e.parent = this),
          ri(e).repeatDelay || (e.repeat = 0),
          (e.immediateRender = !!e.immediateRender),
          new _r(t, e, bi(this, i), 1),
          this
        );
      }),
      (i.call = function (t, e, i) {
        return Di(this, _r.delayedCall(0, t, e), bi(this, i));
      }),
      ...
      (i.staggerFrom = function (t, e, i, r, n, s, o) {
        return (
          (i.runBackwards = 1),
          (ri(i).immediateRender = pe(i.immediateRender)),
      ...
      (i.staggerFromTo = function (t, e, i, r, n, s, o, a) {
        return (
          (r.startAt = i),
          (ri(r).immediateRender = pe(r.immediateRender)),
      ...
      (i.render = function (t, e, i) {
        var r,
          ...
          m = this._dur,
          v = this !== Ft && t > g - ie && t >= 0 ? g : t < ie ? 0 : t,
        ...
        if (v !== this._tTime || i || y) {
          if (
            ...
            if (
              ...
              if (
                ...
                (D = _ ? 0 : m),
                (this._lock = 1),
                (this.render(D || (p ? 0 : Ye(o * a)), e, !m)._lock = 0),
                !e && this.parent && qi(this, "onRepeat"),
          ...
          if (
            ...
            return (this._start = h), di(this), this.render(t, e, i);
          this._onUpdate && !e && qi(this, "onUpdate", !0),
            ((v === g && g >= this.totalDuration()) || (!v && D)) &&
              ((h !== this._start && Math.abs(c) === Math.abs(this._ts)) ||
                ...
                e ||
                  (t < 0 && !D) ||
                  (!v && !D) ||
                  (qi(this, v === g ? "onComplete" : "onReverseComplete", !0),
                  this._prom &&
      ...
      (i.add = function (t, e) {
        var i = this;
        if ((he(e) || (e = bi(this, e)), !(t instanceof cr))) {
          if (ve(t))
            return (
              t.forEach(function (t) {
                return i.add(t, e);
          ...
          if (ue(t)) return this.addLabel(t, e);
          if (!ce(t)) return this;
          t = _r.delayedCall(0, t);
        }
        return this !== t ? Di(this, t, e) : this;
      }),
      ...
      (i.addLabel = function (t, e) {
        return (this.labels[t] = bi(this, e)), this;
      }),
      (i.removeLabel = function (t) {
        return delete this.labels[t], this;
      }),
      (i.addPause = function (t, e, i) {
        var r = _r.delayedCall(0, e || Me, i);
        return (
          (r.data = "isPause"), (this._hasPause = 1), Di(this, r, bi(this, t))
        );
      }),
      (i.removePause = function (t) {
        var e = this._first;
        for (t = bi(this, t); e; )
          e._start === t && "isPause" === e.data && si(e), (e = e._next);
      }),
      ...
      (i.getTweensOf = function (t, e) {
        for (var i, r = [], n = Si(t), s = this._first, o = he(e); s; )
          s instanceof _r
            ? Xe(s._targets, n) &&
              (o
                ? (!dr || (s._initted && s._ts)) &&
            ...
            Ze(
              {
                ...
                onStart: function () {
                  ...
                  u._dur !== t && yi(u, t, 0, 1).render(u._time, !0, !0),
                    o && o.apply(u, a || []);
                },
              },
              e
      ...
      (i.tweenFromTo = function (t, e, i) {
        return this.tweenTo(e, Ze({ startAt: { time: bi(this, t) } }, i));
      }),
      (i.recent = function () {
        return this._recent;
      }),
      (i.nextLabel = function (t) {
        return void 0 === t && (t = this._time), Ri(this, bi(this, t));
      }),
      (i.previousLabel = function (t) {
        return void 0 === t && (t = this._time), Ri(this, bi(this, t), 1);
      }),
          ...
          for (r = s.parent; o; )
            (e = o._prev),
              ...
              (i = o._start) > a && s._sort && o._ts && !s._lock
                ? ((s._lock = 1), (Di(s, o, i - o._delay, 1)._lock = 0))
                : (a = i),
              i < 0 &&
                o._ts &&
                ((n -= i),
              ...
              (o = e);
          yi(s, s === Ft && s._time > n ? s._time : n, 1, 1), (s._dirty = 0);
        }
        return s._tDur;
      }),
      (e.updateRoot = function (t) {
        if ((Ft._ts && (Ke(Ft, hi(t, Ft)), (Ot = $i.frame)), $i.frame >= qe)) {
          qe += Jt.autoSleep || 120;
          var e = Ft._first;
          if ((!e || !e._ts) && Jt.autoSleep && $i._listeners.length < 2) {
  ...
  Ze(hr.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
  var dr,
    fr = function (t, e, i, r, n, s, o) {
      var a,
        l,
        u,
        c,
        ...
        f,
        p,
        D = new Lr(this._pt, t, e, 0, 1, Sr, null, n),
        g = 0,
        m = 0;
      for (
        D.b = i,
    ...
    pr = function (t, e, i, r, n, s, o, a, l) {
      ...
      var u,
        ...
        h =
          "get" !== i
            ...
            ? l
              ? t[
                  e.indexOf("set") || !ce(t["get" + e.substr(3)])
                    ? e
                    : "get" + e.substr(3)
                ](l)
              : t[e]()
      ...
      if (
        ...
        return isNaN(h * r)
          ? (!c && !(e in t) && Ae(e, r),
            fr.call(this, t, e, h, r, d, a || Jt.stringFilter, l))
          : ((u = new Lr(
              this._pt,
              t,
              e,
    ...
    Dr = function (t, e, i, r, n, s) {
      ...
      if (
          ...
          (o = new je[t]()).init(
            ...
            o.rawVars
              ...
              : (function (t, e, i, r, n) {
                  if (
                    (ce(t) && (t = mr(t, n, e, i, r)),
                    !fe(t) || (t.style && t.nodeType) || ve(t) || me(t))
                  )
                    return ue(t) ? mr(t, n, e, i, r) : t;
                  var s,
                    o = {};
                  for (s in t) o[s] = mr(t[s], n, e, i, r);
                  return o;
                })(e[t], r, n, s, i),
            i,
            r,
        ...
        ((i._pt = a = new Lr(i._pt, n, t, 0, 1, o.render, o, 0, o.priority)),
        i !== Mt)
      )
    ...
    gr = function t(e, i) {
      var r,
        ...
        B = "auto" === e._overwrite && !Et,
        L = e.timeline;
      if (
        (L && (!F || !m) && (m = "none"),
        (e._ease = nr(m, te.ease)),
        (e._yEase = E ? ir(nr(!0 === E ? m : E, te.ease)) : 0),
        E &&
          e._yoyo &&
          !e._repeat &&
        ...
        if (
          ((p = (c = k[0] ? He(k[0]).harness : 0) && g[c.prop]),
          (r = ii(g, Be)),
          A && A.render(-1, !0).kill(),
          v)
        )
          ...
          if (A) !T && (e._startAt = 0);
            ...
            p && (s[c.prop] = p),
            si((e._startAt = _r.set(k, s))),
            y)
          ) {
            if (!i) return;
          } else t(e._startAt, ie);
        for (
          e._pt = 0, _ = (S && pe(_)) || (_ && !S), n = 0;
          n < k.length;
          n++
        ) {
          if (
            ((u = (a = k[n])._gsap || Ve(k)[n]._gsap),
            (e._ptLookup[n] = d = {}),
            Pe[u.id] && Le.length && Ue(),
            (f = M === k ? n : M.indexOf(a)),
            c &&
              !1 !== (h = new c()).init(a, p || r, e, f, M) &&
              ((e._pt = o =
                new Lr(e._pt, a, h.name, 0, 1, h.render, h, 0, h.priority)),
            ...
            for (s in r)
              je[s] && (h = Dr(s, r, e, f, a, M))
                ? h.priority && (l = 1)
                : (d[s] = o =
                    pr.call(e, a, s, "get", r[s], f, M, 0, g.stringFilter));
          e._op && e._op[n] && e.kill(a, e._op[n]),
            B &&
              e._pt &&
              ((dr = e),
              Ft.killTweensOf(a, d, e.globalTime(0)),
              (D = !e.parent),
              (dr = 0)),
            e._pt && _ && (Pe[u.id] = 1);
        }
    ...
    mr = function (t, e, i, r, n) {
      return ce(t)
        ? t.call(e, i, r, n)
        : ue(t) && ~t.indexOf("random(")
        ? Pi(t)
        : t;
    },
    vr = Ie + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase",
    yr = (vr + ",id,stagger,delay,duration,paused,scrollTrigger").split(","),
    _r = (function (t) {
      function e(e, i, r, n) {
        var s;
        ...
        var o,
          ...
          d,
          f,
          p = (s = t.call(this, n ? i : ri(i), r) || this).vars,
          D = p.duration,
          g = p.delay,
          m = p.immediateRender,
          v = p.stagger,
          ...
          x = p.yoyoEase,
          C = s.parent,
          E = (ve(e) || me(e) ? he(e[0]) : "length" in i) ? [e] : Si(e);
        if (
          ((s._targets = E.length
            ? Ve(E)
            : ke(
          ...
          if (
            ((i = s.vars),
            (o = s.timeline =
              new hr({ data: "nested", defaults: w || {} })).kill(),
            (o.parent = o._dp = xt(s)),
            (o._start = 0),
            _)
          )
            Ze(o.vars.defaults, { ease: "none" }),
              _.forEach(function (t) {
                return o.to(E, t, ">");
              });
          else {
            if (((u = E.length), (d = v ? ki(v) : Me), fe(v)))
              for (c in v) ~vr.indexOf(c) && (f || (f = {}), (f[c] = v[c]));
            for (a = 0; a < u; a++) {
              for (c in ((l = {}), i)) yr.indexOf(c) < 0 && (l[c] = i[c]);
              (l.stagger = 0),
                x && (l.yoyoEase = x),
                f && ti(l, f),
                (h = E[a]),
                (l.duration = +mr(D, xt(s), a, h, E)),
                (l.delay = (+mr(g, xt(s), a, h, E) || 0) - s._delay),
                !v &&
                  1 === u &&
                  l.delay &&
        ...
        return (
          !0 !== y || Et || ((dr = xt(s)), Ft.killTweensOf(E), (dr = 0)),
          C && pi(C, xt(s)),
          (m ||
            (!D &&
              !_ &&
      ...
      return (
          ...
          if (p) {
              ...
              if (((r = D), (c = this.timeline), this._repeat)) {
                ...
                s !== a &&
                  ...
                  !this.vars.repeatRefresh ||
                    ...
                    this._lock ||
                    ((this._lock = i = 1),
                    (this.render(Ye(o * s), !0).invalidate()._lock = 0)));
              }
              if (!this._initted) {
                if (mi(this, t < 0 ? t : r, i, e))
              ...
              (c && c.render(t < 0 ? t : !r && l ? -1e-8 : c._dur * u, e, i)) ||
                ...
                (D !== this._tDur && D) ||
                  ...
                  e ||
                    (t < 0 && !d) ||
                    (!D && !d) ||
                    (qi(this, D === f ? "onComplete" : "onReverseComplete", !0),
                    this._prom &&
            ...
            !(function (t, e, i, r) {
              ...
              if (
                ...
                l !== a || r || t._zTime === ie || (!e && t._zTime))
              ) {
                if (!t._initted && mi(t, e, r, i)) return;
                for (
                  o = t._zTime,
                    t._zTime = e || (i ? ie : 0),
                    i || (i = e && !o),
                ...
                t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                  t._onUpdate && !i && qi(t, "onUpdate"),
                  c && t._repeat && !i && t.parent && qi(t, "onRepeat"),
                  (e >= t._tDur || e < 0) &&
                    t.ratio === l &&
                    (l && si(t, 1),
                    i ||
                      (qi(t, l ? "onComplete" : "onReverseComplete", !0),
                      t._prom && t._prom()));
        ...
        (i.kill = function (t, e) {
          ...
          if (this.timeline) {
            ...
            return (
              this.timeline.killTweensOf(t, e, dr && !0 !== dr.vars.overwrite)
                ._first || zi(this),
              this.parent &&
                i !== this.timeline.totalDuration() &&
                yi(this, (this._dur * this.timeline._tDur) / i, 0, 1),
              this
            );
          }
          var r,
          ...
          if (
            ...
            return "all" === e && (this._pt = 0), zi(this);
          for (
            r = this._op = this._op || [],
              "all" !== e &&
                (ue(e) &&
            ...
            if (~h.indexOf(c[u]))
              ...
              o))
                (l = n && n[a]) &&
                  (("kill" in l.d && !0 !== l.d.kill(a)) || ni(this, l, "_pt"),
                  delete n[a]),
                  "all" !== s && (s[a] = 1);
  ...
  Ze(_r.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
    Ne("staggerTo,staggerFrom,staggerFromTo", function (t) {
      _r[t] = function () {
        var e = new hr(),
          i = Fi.call(arguments, 0);
  ...
  var wr = function (t, e, i) {
    ...
    Er = function (t, e) {
      return ce(t[e]) ? br : de(t[e]) && t.setAttribute ? Cr : wr;
    },
    Fr = function (t, e) {
  ...
  Ne(
    ...
    (Fe.TweenMax = Fe.TweenLite = _r),
    (Fe.TimelineLite = Fe.TimelineMax = hr),
    (Ft = new hr({
      sortChildren: !1,
      defaults: te,
  ...
  var Pr = {
    ...
    getProperty: function (t, e, i, r) {
      ...
      return (
        ...
        t
          ? e
            ? s(((je[e] && je[e].get) || n)(t, e, i, r))
            : function (e, i, r) {
                return s(((je[e] && je[e].get) || n)(t, e, i, r));
              }
          : t
      );
    },
    ...
    defaults: function (t) {
      return t && t.ease && (t.ease = nr(t.ease, te.ease)), ei(te, t || {});
    },
    config: function (t) {
      return ei(Jt, t || {});
    },
    registerEffect: function (t) {
      ...
      (r || "").split(",").forEach(function (t) {
        return (
          t && !je[t] && !Fe[t] && ke(e + " effect requires " + t + " plugin.")
        );
      }),
        (Re[e] = function (t, e, r) {
          return i(Si(t), Ze(e || {}, n), r);
        }),
        s &&
          (hr.prototype[e] = function (t, i, r) {
            return this.add(Re[e](t, fe(i) ? i : (r = i) && {}, this), r);
          });
    },
    ...
    parseEase: function (t, e) {
      return arguments.length ? nr(t, e) : Zi;
    },
    getById: function (t) {
      return Ft.getById(t);
    },
    exportRoot: function (t, e) {
      ...
      var i,
        ...
        n = new hr(t);
      for (
        n.smoothChildTiming = pe(t.smoothChildTiming),
          Ft.remove(n),
          n._dp = 0,
    ...
    utils: {
      ...
      interpolate: function t(e, i, r, n) {
        ...
        if (!s) {
          ...
          if (!l) {
            for (o in i) pr.call(d, e, o, "get", i[o]);
            s = function (t) {
              return Ar(t, d) || (h ? e.p : e);
            };
          }
        }
        return xi(r, s);
  ...
  (_r.version = hr.version = qr.version = "3.6.1"), (kt = 1), De() && Qi();
  Zi.Power0,
    Zi.Power1,
    Zi.Power2,
    Zi.Power3,
  ...
  var zr,
    ...
    pn = fn + "Origin",
    Dn = function (t, e) {
      var i = Ir.createElementNS
        ? Ir.createElementNS(
            (e || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"),
            t
          )
        : Ir.createElement(t);
      return i.style ? i : Ir.createElement(t);
    },
    gn = function t(e, i, r) {
      var n = getComputedStyle(e);
      return (
        n[i] ||
        n.getPropertyValue(i.replace($r, "-$1").toLowerCase()) ||
    ...
    vn = function (t, e, i) {
      ...
      return n < 0 ? null : (3 === n ? "ms" : n >= 0 ? mn[n] : "") + t;
    },
    yn = function () {
      "undefined" != typeof window &&
        window.document &&
        ...
        e in Xr && e !== pn && (e = fn),
          i.removeProperty
            ? (("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6)) ||
                (e = "-" + e),
              i.removeProperty(e.replace($r, "-$1").toLowerCase()))
            : i.removeAttribute(e);
      }
    },
    En = function (t, e, i, r, n, s) {
      var o = new Lr(t._pt, e, i, 0, 1, s ? on : sn);
    ...
    Tn = function t(e, i, r, n) {
      var s,
        ...
        g = "px" === n,
        m = "%" === n;
      return n === c || !u || Fn[n] || Fn[c]
        ? u
        : ("px" !== c && !g && (u = t(e, i, r, "px")),
          (l = e.getCTM && xn(e)),
          (!m && "%" !== c) || (!Xr[i] && !~i.indexOf("adius"))
            ? ((h[d ? "width" : "height"] = D + (g ? c : n)),
              ...
              (a = o._gsap) && m && a.width && d && a.time === $i.time
                ? Ye((u / a.width) * D)
                : ((m || "%" === c) && (h.position = gn(e, "position")),
                  o === e && (h.position = "static"),
                  o.appendChild(Wr),
                  (s = Wr[p]),
                  o.removeChild(Wr),
                  (h.position = "absolute"),
                  d && m && (((a = He(o)).time = $i.time), (a.width = o[p])),
                  Ye(g ? (s * u) / D : s && u ? (D / s) * u : 0)))
        ...
        Xr[e] && "transform" !== e
          ...
          : (!(n = t.style[e]) ||
            ...
            (n =
              ...
              We(t, e) ||
              ("opacity" === e ? 1 : 0)),
        i && !~(n + "").trim().indexOf(" ") ? Tn(t, e, n, i) + i : n
      );
    },
    An = function (t, e, i, r) {
      if (!i || "none" === i) {
        ...
        s && s !== i
          ? ((e = n), (i = s))
          : "borderColor" === e && (i = gn(t, "borderTopColor"));
      }
      var o,
        a,
        l,
        ...
        g,
        m,
        v = new Lr(this._pt, t.style, e, 0, 1, Sr),
        y = 0,
        _ = 0;
      if (
        ((v.b = i),
        ...
        (i += ""),
        "auto" === (r += "") &&
          ((t.style[e] = r), (r = gn(t, e) || r), (t.style[e] = i)),
        Ki((o = [i, r])),
        (r = o[1]),
        (l = (i = o[0]).match(we) || []),
        (r.match(we) || []).length)
      ...
      } else v.r = "display" === e && "none" === r ? on : sn;
      ...
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if ("all" === a || !0 === a) (o.cssText = ""), (r = 1);
          ...
          for (n = (a = a.split(",")).length; --n > -1; )
            (i = a[n]),
              Xr[i] && ((r = 1), (i = "transformOrigin" === i ? pn : fn)),
              Cn(s, i);
        r &&
          (Cn(s, fn),
          l &&
    ...
    Mn = {
      clearProps: function (t, e, i, r, n) {
        if ("isFromStart" !== n.data) {
          var s = (t._pt = new Lr(t._pt, e, i, 0, 0, On));
    ...
    jn = function (t) {
      var e = gn(t, fn);
      return Pn(e) ? Bn : e.substr(7).match(_e).map(Ye);
    },
    Rn = function (t, e) {
      var i,
        r,
      ...
      return o.svg && t.getAttribute("transform")
        ...
        : (l !== Bn ||
            ...
            ((i = t.parentNode) && t.offsetParent) ||
              ((s = 1), (r = t.nextSibling), Vr.appendChild(t)),
            (l = jn(t)),
            n ? (a.display = n) : Cn(t, "display"),
            s &&
              (r
                ? i.insertBefore(t, r)
                : i
    ...
    qn = function (t, e, i, r, n, s) {
      ...
      i
        ? c !== Bn &&
          ...
          (x = l))
        : ((b = (o = bn(t)).x + (~w[0].indexOf("%") ? (b / 100) * o.width : b)),
          (x =
        ...
        s &&
          (En(s, u, "xOrigin", h, b),
          En(s, u, "yOrigin", d, x),
          En(s, u, "xOffset", f, u.xOffset),
          En(s, u, "yOffset", p, u.yOffset)),
        t.setAttribute("data-svg-origin", b + " " + x);
    },
    zn = function (t, e) {
      var i = t._gsap || new ur(t);
      ...
      return (
        ...
        i.svg &&
          ...
          qn(t, F || z, !!F || i.originIsAbsolute, !1 !== i.smooth, g)),
        (p = i.xOrigin || 0),
        (D = i.yOrigin || 0),
        g !== Bn &&
          ((_ = g[0]),
          ...
          6 === g.length
            ...
            : ((L = g[6]),
              ...
              u &&
                ...
                ((u = l = 0), (c = 180 - c)),
              (o = Ye(Math.sqrt(_ * _ + w * w + b * b))),
              (a = Ye(Math.sqrt(E * E + L * L))),
              (m = Kr(C, E)),
              (h = Math.abs(m) > 2e-4 ? m * Gr : 0),
              (f = B ? 1 / (B < 0 ? -B : B) : 0)),
          i.svg &&
            ((F = t.getAttribute("transform")),
            (i.forceCSS = t.setAttribute("transform", "") || !Pn(gn(t, fn))),
        ...
        (i.zOrigin = parseFloat(z.split(" ")[2]) || 0) && (P[pn] = In(z)),
        (i.xOffset = i.yOffset = 0),
        (i.force3D = Jt.force3D),
        (i.renderTransform = i.svg ? Gn : Yr ? Xn : Hn),
        (i.uncache = 0),
        i
      );
    },
    ...
    Vn = function (t, e, i) {
      var r = Ei(e);
      return Ye(parseFloat(e) + parseFloat(Tn(t, "x", i + "px", r))) + r;
    },
    Hn = function (t, e) {
      (e.z = "0px"),
    ...
    Xn = function (t, e) {
      ...
      if (v && (c !== Wn || u !== Wn)) {
        ...
        (b = parseFloat(c) * Ur),
          (w = Math.cos(b)),
          (s = Vn(m, s, x * w * -v)),
          (o = Vn(m, o, -Math.sin(b) * -v)),
          (a = Vn(m, a, C * w * -v + v));
      }
      D !== Nn && (y += "perspective(" + D + Yn),
        (r || n) && (y += "translate(" + r + "%, " + n + "%) "),
        (_ || s !== Nn || o !== Nn || a !== Nn) &&
          (y +=
            a !== Nn || _
        ...
        u !== Wn && (y += "rotateY(" + u + Yn),
        c !== Wn && (y += "rotateX(" + c + Yn),
        (h === Wn && d === Wn) || (y += "skew(" + h + ", " + d + Yn),
        (1 === f && 1 === p) || (y += "scale(" + f + ", " + p + Yn),
    ...
    Gn = function (t, e) {
      ...
      (d = parseFloat(d)),
        ...
        ((x && !~(c + "").indexOf("px")) || (C && !~(h + "").indexOf("px"))) &&
          ((x = Tn(m, "x", c, "px")), (C = Tn(m, "y", h, "px"))),
        (v || y || _ || w) &&
          ((x = Ye(x + v - (v * i + y * n) + _)),
          (C = Ye(C + y - (v * r + y * s) + w))),
        (l || u) &&
          ((o = m.getBBox()),
          (x = Ye(x + (l / 100) * o.width)),
          (C = Ye(C + (u / 100) * o.height))),
        (o =
          "matrix(" +
          i +
          "," +
    ...
    Un = function (t, e, i, r, n, s) {
      var o,
        a,
        l = 360,
        u = ue(n),
        c = parseFloat(n) * (u && ~n.indexOf("rad") ? Gr : 1),
        h = s ? c * s : c - r,
        d = r + h + "deg";
      return (
        u &&
        ...
        (t._pt = a = new Lr(t._pt, e, i, r, h, en)),
        (a.e = d),
        (a.u = "deg"),
        t._props.push(i),
        a
    ...
    $n = function (t, e, i) {
      ...
      Xr))
        (s = c[n]) !== (o = r[n]) &&
          ...
          ((a = Ei(s) !== (u = Ei(o)) ? Tn(i, n, s, u) : parseFloat(s)),
          (l = parseFloat(o)),
          (t._pt = new Lr(t._pt, r, n, a, l - a, tn)),
          (t._pt.u = u || 0),
          t._props.push(n));
      Kn(r, c);
    };
  Ne("padding,margin,Width,Radius", function (t, e) {
    ...
    Mn[e > 1 ? "border" + t : t] = function (t, e, i, r, n) {
      var s, a;
    ...
    ts = {
      ...
      init: function (t, e, i, r, n) {
        ...
        for (h in (Hr || yn(), e))
          if (
            "autoRound" !== h &&
            ((o = e[h]), !je[h] || !Dr(h, e, i, r, t, n))
          )
            if (
              ((u = typeof o),
              (c = Mn[h]),
              "function" === u && (u = typeof (o = o.call(i, r, t, n))),
              "string" === u && ~o.indexOf("random(") && (o = Pi(o)),
              c)
            )
              c(this, t, h, o, i) && (y = 1);
              ...
              (s = (getComputedStyle(t).getPropertyValue(h) + "").trim()),
                (o += ""),
                (Gi.lastIndex = 0),
                Gi.test(s) || ((d = Ei(s)), (f = Ei(o))),
                f ? d !== f && (s = Tn(t, h, s, f) + f) : d && (o += d),
              ...
              if (
                (F && h in F
                  ? ((s =
                    ...
                    h in Jt.units && !Ei(s) && (s += Jt.units[h]),
                    "=" === (s + "").charAt(1) && (s = Sn(t, h)))
                  : (s = Sn(t, h)),
                (l = parseFloat(s)),
                (p =
                    ...
                    (w = void 0),
                      ...
                      m.svg
                        ...
                        : ((f = parseFloat(o.split(" ")[2]) || 0) !==
                            m.zOrigin && En(this, m, "zOrigin", m.zOrigin, f),
                          En(this, E, h, In(s), In(o)));
                    continue;
                  }
                  if ("svgOrigin" === h) {
                    qn(t, o, 1, v, 0, this);
              ...
              if (
                D ||
                ((a || 0 === a) && (l || 0 === l) && !Zr.test(o) && h in E)
              )
                a || (a = 0),
                  (d = (s + "").substr((l + "").length)) !==
                    (f = Ei(o) || (h in Jt.units ? Jt.units[h] : d)) &&
                    (l = Tn(t, h, s, f)),
                  (this._pt = new Lr(
                    this._pt,
                    D ? m : E,
                  ...
                  (this._pt.u = f || 0),
                  d !== f && ((this._pt.b = s), (this._pt.r = rn));
              else if (h in E) An.call(this, t, h, s, o);
              else {
                if (!(h in t)) {
                  Ae(h, o);
                  continue;
      ...
      getSetter: function (t, e, i) {
        ...
        return (
          r && r.indexOf(",") < 0 && (e = r),
          e in Xr && e !== pn && (t._gsap.x || Sn(t, "x"))
            ? i && Nr === i
              ? "scale" === e
                ? cn
                : un
              : (Nr = i || {}) && ("scale" === e ? hn : dn)
            : t.style && !de(t.style[e])
            ? an
            : ~e.indexOf("-")
            ? ln
            : Er(t, e)
      ...
      core: { _removeProperty: Cn, _getMatrix: Rn },
    };
  (qr.utils.checkPrefix = vn),
    (Jn = Ne(
      (Qn = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") +
        "," +
        (Zn = "rotation,rotationX,rotationY,skewX,skewY") +
    ...
    qr.registerPlugin(ts);
  var es = qr.registerPlugin(ts) || qr,
    is = (es.core.Tween, /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi),
    rs = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,
    ns = Math.PI / 180,
    ss = (Math.PI, Math.sin),
    os = Math.cos,
   ...
   */ function hs(t, e, i, r, n, s, o, a, l) {
    if (t !== a || e !== l) {
      ...
      var C = (s === o ? -1 : 1) * ls(x),
        ...
        M = (-m - F) / r,
        B = A * A + k * k,
        L = (k < 0 ? -1 : 1) * Math.acos(A / ls(B)),
        P =
          (A * M - k * O < 0 ? -1 : 1) *
          Math.acos((A * O + k * M) / ls(B * (O * O + M * M)));
      isNaN(P) && (P = d),
        !o && P > 0 ? (P -= f) : o && P < 0 && (P += f),
        (L %= f),
        (P %= f);
      var j,
        R = Math.ceil(as(P) / (f / 4)),
        q = [],
        z = P / R,
        I = ((4 / 3) * ss(z / 2)) / (1 + os(z / 2)),
        V = c * i,
        H = h * i,
        W = h * -r,
        N = c * r;
  ...
  var ds,
    ...
    Ds = function () {
      (ds = ps())
        ? (ds.registerEase("_CE", _s.create), (fs = 1))
    ...
    ms = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
    vs = /[cLlsSaAhHvVtTqQ]/g,
    ys = function t(e, i, r, n, s, o, a, l, u, c, h) {
      var d,
        f = (e + r) / 2,
        p = (i + n) / 2,
        D = (r + s) / 2,
    ...
    _s = (function () {
      function t(t, e, i) {
        fs || Ds(), (this.id = t), this.setData(e, i);
      }
      var e = t.prototype;
      return (
        (e.setData = function (t, e) {
          ...
          if (
            ((this.data = t),
            (vs.test(t) || (~t.indexOf("M") && t.indexOf("C") < 0)) &&
              (h = (function (t) {
                var e,
                  i,
                  r,
          ...
          return (
            ...
            this.id && ds.registerEase(this.id, this.ease),
            this
          );
        }),
        ...
        (t.getSVGData = function (e, i) {
          var r,
            ...
            D = i.x || 0,
            g = (i.y || 0) + p,
            m = ds.utils.toArray(i.path)[0];
          if (
            (i.invert && ((p = -p), (g = 0)),
            "string" == typeof e && (e = ds.parseEase(e)),
            e.custom && (e = e.custom),
            e instanceof t)
          )
            r = (function (t) {
  ...
  ps() && ds.registerPlugin(_s), (_s.version = "3.6.1"), es.registerPlugin(_s);
  let ws = _s.create(
    "smooth",
   ...
   */ var bs,
    ...
    Ss = function () {
      return bs || (Ts() && (bs = window.gsap) && bs.registerPlugin && bs);
    },
    As = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
    ks = {
      rect: ["width", "height"],
    ...
    Bs = function (t, e) {
      return Ms(t.getAttribute(e));
    },
    Ls = Math.sqrt,
    Ps = function (t, e, i, r, n, s) {
      return Ls(
        Math.pow((Ms(i) - Ms(t)) * n, 2) + Math.pow((Ms(r) - Ms(e)) * s, 2)
      );
    },
    js = function (t) {
    ...
    qs = function (t) {
      ...
      Rs(t) &&
        ((h = t.getScreenCTM()),
        (c = Ls(h.a * h.a + h.b * h.b)),
        (h = Ls(h.d * h.d + h.c * h.c)));
      try {
        i = t.getBBox();
      } catch (t) {
        js(
      ...
      else if ("line" === l) e = Ps(f, p, f + D, p + g, c, h);
      else if ("polyline" === l || "polygon" === l)
        for (
          r = t.getAttribute("points").match(As) || [],
          ...
          e += Ps(r[s - 2], r[s - 1], r[s], r[s + 1], c, h) || 0;
      else
        ("circle" !== l && "ellipse" !== l) ||
          ((o = (D / 2) * c),
          (a = (g / 2) * h),
          (e = Math.PI * (3 * (o + a) - Ls((3 * o + a) * (o + 3 * a)))));
      return e || 0;
    },
    zs = function (t, e) {
      if (!(t = xs(t)[0])) return [0, 0];
      e || (e = qs(t) + 1);
      var i = Cs.getComputedStyle(t),
        r = i.strokeDasharray || "",
        n = Ms(i.strokeDashoffset),
        s = r.indexOf(",");
      return (
        s < 0 && (s = r.indexOf(" ")),
        (r = s < 0 ? e : Ms(r.substr(0, s)) || 1e-5) > e && (r = e),
    ...
    Is = function () {
      Ts() &&
        ...
        (Fs = bs = Ss()),
        (xs = bs.utils.toArray),
        (Es = -1 !== ((Cs.navigator || {}).userAgent || "").indexOf("Edge")));
    },
    Vs = {
      version: "3.4.0",
      name: "drawSVG",
        ...
        return (
          ...
          (o = (function (t, e, i) {
            ...
            return (
              ...
              (r = ~r.indexOf("%") ? (Ms(r) / 100) * e : Ms(r)) >
              (n = ~n.indexOf("%") ? (Ms(n) / 100) * e : Ms(n))
                ? [n, r]
                : [r, n]
            );
          })(e, u, (s = zs(t, u))[0])),
          (this._length = Os(u + 10)),
          0 === s[0] && 0 === o[0]
            ? ((a = Math.max(1e-5, o[1] - u)),
              (this._dash = Os(u + a)),
              (this._offset = Os(u - s[1] + a)),
          ...
          Es &&
            (l = Cs.getComputedStyle(t)).strokeLinecap !== l.strokeLinejoin &&
            ((o = Ms(l.strokeMiterlimit)),
            this.add(t.style, "strokeMiterlimit", o, o + 0.01)),
          (this._live = Rs(t) || ~(e + "").indexOf("live")),
  ...
  Ss() && bs.registerPlugin(Vs);
  class Hs extends bt.Transition {
    in({ from: t, to: e, trigger: i, done: r }) {
      es.registerPlugin(Vs),
        document.querySelector(".c-play__bg").classList.remove("--play");
      es.timeline({ defaults: { ease: ws } })
        ...
        .fromTo(
          "#l_path",
          { drawSVG: 0 },
          { drawSVG: "100%", duration: 1.2, ease: ws },
          "-=.5"
        )
        .fromTo(
          "#dot_path",
    ...
    out({ from: t, done: e }) {
      es.timeline({ defaults: { ease: ws } })
        ...
        .to(t, {
          ...
          ease: "Power4.out",
          onComplete: () => {
            ft.scrollTo(".c-play-title", { duration: 0, disableLerp: !0 }),
              ft.stop();
          },
        })
        ...
        .set(".c-play__bg", {
          opacity: 1,
          onComplete: () => {
            t.remove(), ft.update(), e();
          },
        });
    }
  }
  class Ws extends bt.Transition {
    in({ from: t, to: e, trigger: i, done: r }) {
      es.timeline({ defaults: { ease: ws } })
    ...
    out({ from: t, done: e }) {
      es.timeline({ defaults: { ease: ws } })
        ...
        .to(t, {
          ...
          duration: 0.9,
          onComplete: () => {
            ft.scrollTo(".c-title", { duration: 0, disableLerp: !0 }),
              ft.stop();
          },
        })
  ...
  function Ys(t) {
    ...
    if (1 === e || 9 === e || 11 === e) {
      ...
      for (t = t.firstChild; t; t = t.nextSibling) i += Ys(t);
  ...
  var Xs,
    ...
    to = function (t, e) {
      ...
      return Zs(t)
        ...
        ? Js.call(Xs.querySelectorAll(t), 0)
    ...
    uo = function (t, e, i, r, n, s, o) {
      var a,
        ...
        _ = lo("paddingLeft", y),
        w = -999,
        b = lo("borderBottomWidth", y) + lo("borderTopWidth", y),
        x = lo("borderLeftWidth", y) + lo("borderRightWidth", y),
        C = lo("paddingTop", y) + lo("paddingBottom", y),
        E = lo("paddingLeft", y) + lo("paddingRight", y),
        F = 0.2 * lo("fontSize", y),
        T = y.textAlign,
        S = [],
        A = [],
          ...
          ((d = (c = h[a]).parentNode === t) || R || (j && !P)) &&
            ...
            L &&
              (((c._isSplit && d) ||
                ...
                (f.push(c), (c._x -= _), oo(c, t, O) && (c._wordEnd = !0)),
              "BR" === c.nodeName &&
              ...
              !P && j
                ? c._isSplit
                  ...
                  ? ((c._parent = c.parentNode),
                    ...
                    u--)
                  : d ||
                    ((v = !c.nextSibling && oo(c.parentNode, t, O)),
                    c.parentNode._parent && c.parentNode._parent.appendChild(c),
                    v && c.parentNode.appendChild(Xs.createTextNode(" ")),
      ...
      if (L) {
        ...
        for (p = " " === O && (!R || (!P && !j)), a = 0; a < L.length; a++) {
          for (
            f = L[a],
              (g = Xs.createElement(M)).style.cssText =
            ...
            "BR" !== f[l].nodeName &&
              ((c = f[l]),
              g.appendChild(c),
              p && c._wordEnd && g.appendChild(Xs.createTextNode(" ")),
              R &&
                (0 === l &&
          ...
          0 === u
            ? (g.innerHTML = "&nbsp;")
            : P || j || (ao(g), no(g, String.fromCharCode(160), " ")),
            R && ((g.style.width = m), (g.style.height = c._h + "px")),
            t.appendChild(g);
        }
        t.style.cssText = D;
      }
      ...
      var n,
        ...
        y = e.specialChars
          ? "function" == typeof e.specialChars
            ...
            : io
          : null,
        _ = Xs.createElement("div"),
        w = t.parentNode;
      for (
        w.insertBefore(_, t),
          _.textContent = t.nodeValue,
          w.removeChild(t),
          c = -1 !== (n = Ys((t = _))).indexOf("<"),
          !1 !== e.reduceWhiteSpace && (n = n.replace($s, " ").replace(Ks, "")),
          c && (n = n.split("<").join("{{LT}}")),
          l = n.length,
          s = (" " === n.charAt(0) ? g : "") + i(),
          o = 0;
        ...
        if (((u = n.charAt(o)), y && (h = y(n.substr(o), e.specialChars))))
          ...
          "{" === u && "{{LT}}" === n.substr(o, 6)
            ...
            ? ((a = ((n.substr(o, 12).split(Ns) || [])[1] || "").length || 2),
              (s +=
                f && " " !== u
                  ? r() + n.substr(o, a) + "</" + d + ">"
                  : n.substr(o, a)),
        ...
        (e.split = function (t) {
          ...
          for (
            ...
            (r = this.elements[n]),
              ...
              (i = r.clientWidth),
              ho(r, t, o, a),
              uo(r, t, this.chars, this.words, this.lines, i, e);
          return (
            this.chars.reverse(),
            this.words.reverse(),
            this.lines.reverse(),
  ...
  var po,
    ...
    Qo = function () {
      return po || ($o() && (po = window.gsap) && po.registerPlugin && po);
    },
    Zo = function (t) {
      return !!~_o.indexOf(t);
    },
    Jo = function (t, e) {
      return ~Ho.indexOf(t) && Ho[Ho.indexOf(t) + 1][e];
    },
    ta = function (t, e) {
      var i = e.s,
        r = e.sc,
    ...
    ea = function (t) {
      return (
        Jo(t, "getBoundingClientRect") ||
        (Zo(t)
          ? function () {
              return (
                (pl.width = go.innerWidth), (pl.height = go.innerHeight), pl
              );
            }
          : function () {
              return Ma(t);
    ...
    ia = function (t, e) {
      var i = e.s,
        ...
        n = e.d,
        s = e.a;
      return (i = "scroll" + r) && (s = Jo(t, i))
        ? s() - ea(t)()[n]
        : Zo(t)
        ? Math.max(vo[i], yo[i]) -
          (go["inner" + r] || vo["client" + r] || yo["client" + r])
        : t[i] - t["offset" + r];
    },
    ra = function (t, e) {
      for (var i = 0; i < Lo.length; i += 3)
        (!e || ~e.indexOf(Lo[i + 1])) && t(Lo[i], Lo[i + 1], Lo[i + 2]);
    },
    na = function (t) {
      return "string" == typeof t;
    },
    ...
    Aa = {
      ...
      sc: function (t) {
        return arguments.length
          ? go.scrollTo(Sa.sc(), t)
          : go.pageYOffset || mo.scrollTop || vo.scrollTop || yo.scrollTop || 0;
      },
    },
    ka = function (t) {
    ...
    Ia = { top: 0, left: 0, center: 0.5, bottom: 1, right: 1 },
    Va = function (t, e) {
      if (na(t)) {
        var i = t.indexOf("="),
    ...
    Ha = function (t, e, i, r, n, s, o) {
      var a = n.startColor,
        l = n.endColor,
        u = n.fontSize,
        c = n.indent,
        h = n.fontWeight,
        d = mo.createElement("div"),
        f = Zo(i) || "fixed" === Jo(i, "pinType"),
      ...
      return (
        ...
        (p || !f) &&
          (v += (r === Aa ? Da : ga) + ":" + (s + parseFloat(c)) + "px;"),
        o &&
          (v +=
    ...
    Ga = function () {
      xo || ((xo = bo(al)), Xo || tl("scrollStart"), (Xo = No()));
    },
    Ua = function () {
      return !So && !Ro && !mo.fullscreenElement && wo.restart(!0);
    },
    Ka = {},
    $a = [],
    Qa = [],
    Za = function (t) {
      var e,
        ...
        n = 0;
      if (Io !== i || Vo) {
        for (rl(); n < Qa.length; n += 4)
          (e = go.matchMedia(Qa[n]).matches) !== Qa[n + 3] &&
            ((Qa[n + 3] = e),
            e ? r.push(n) : rl(1, Qa[n]) || (sa(Qa[n + 2]) && Qa[n + 2]()));
        for (il(), n = 0; n < r.length; n++)
          (e = r[n]), (zo = Qa[e]), (Qa[e + 2] = Qa[e + 1](t));
        (zo = 0), Do && nl(0, 1), (Io = i), tl("matchMedia");
      }
    },
    Ja = function t() {
      return Ra(yl, "scrollEnd", t) || nl(!0);
    },
    tl = function (t) {
      return (
        (Ka[t] &&
    ...
    el = [],
    il = function (t) {
      for (var e = 0; e < el.length; e += 4)
        (t && el[e + 3] !== t) ||
          ((el[e].style.cssText = el[e + 1]), (el[e + 2].uncache = 1));
    },
    rl = function (t, e) {
      var i;
      for (Oo = 0; Oo < Na.length; Oo++)
        (i = Na[Oo]),
          (e && i.media !== e) ||
            (t
              ? i.kill(1)
    ...
    nl = function (t, e) {
      if (!Xo || t) {
        var i = tl("refreshInit");
        for (Po && yl.sort(), e || rl(), Oo = 0; Oo < Na.length; Oo++)
          Na[Oo].refresh();
        for (
    ...
    al = function () {
      ...
      if (
        ...
        (sl = r),
        i &&
          (Xo && !Ao && e - Xo > 200 && ((Xo = 0), tl("scrollEnd")),
          (Fo = Yo),
          (Yo = e)),
        ol < 0)
      ) {
        for (Oo = t; Oo-- > 0; ) Na[Oo] && Na[Oo].update(0, i);
        ol = 1;
      } else for (Oo = 0; Oo < t; Oo++) Na[Oo] && Na[Oo].update(0, i);
      xo = 0;
    },
    ll = [
      fa,
    ...
    cl = function (t, e, i, r) {
      if (t.parentNode !== e) {
        for (var n, s = ll.length, o = e.style, a = t.style; s--; )
          o[(n = ll[s])] = i[n];
    ...
    dl = function (t) {
      if (t) {
        var e,
          ...
          n = t.length,
          s = 0;
        for ((t.t._gsap || po.core.getCache(t.t)).uncache = 1; s < n; s += 2)
          (i = t[s + 1]),
            (e = t[s]),
            i
              ? (r[e] = i)
              : r[e] && r.removeProperty(e.replace(hl, "-$1").toLowerCase());
      }
    },
    fl = function (t) {
      for (var e = ul.length, i = t.style, r = [], n = 0; n < e; n++)
        r.push(ul[n], i[ul[n]]);
      return (r.t = t), r;
    },
    pl = { left: 0, top: 0 },
    Dl = function (t, e, i, r, n, s, o, a, l, u, c, h) {
      if (
        (sa(t) && (t = t(a)),
        na(t) &&
          "max" === t.substr(0, 3) &&
          (t = h + ("=" === t.charAt(4) ? Va("0" + t.substr(3), i) : 0)),
        oa(t))
      )
        o && Wa(o, i, r, !0);
      else {
        ...
        (g && (g.left || g.top)) ||
          ...
          o && Wa(o, f, r, i - f < 20 || (o._isStart && f > 20)),
          (i -= i - f);
      }
      if (s) {
        var v = t + i,
        ...
        (h = "scroll" + r.d2),
          Wa(
            ...
            r,
            (y && v > 20) ||
              (!y && (c ? Math.max(yo[h], vo[h]) : s.parentNode[h]) <= v + 1)
          ),
          c &&
            ((l = Ma(o)),
            c && (s.style[r.op.p] = l[r.op.p] - r.op.m - s._offset + Ta));
      }
      return Math.round(t);
    },
    ...
    ml = function (t, e, i, r) {
      if (t.parentNode !== e) {
        var n,
          ...
          o = t.style;
        if (e === yo) {
          for (n in ((t._stOrig = o.cssText), (s = ka(t))))
            +n ||
              gl.test(n) ||
              !s[n] ||
              "string" != typeof o[n] ||
        ...
        (po.core.getCache(t).uncache = 1), e.appendChild(t);
      }
    },
    vl = function (t, e) {
      var i,
  ...
  var yl = (function () {
    ...
    return (
      (t.prototype.init = function (e, i) {
        if (((this.progress = this.start = 0), this.vars && this.kill(1), Go)) {
          var r,
            n,
            s,
            o,
            ...
            I,
            V,
            H = (e = Oa(na(e) || oa(e) || e.nodeType ? { trigger: e } : e, za))
              .horizontal
              ? Sa
              : Aa,
            W = e,
            ...
            st = W.pinReparent,
            ot = !K && 0 !== K,
            at = Co(e.scroller || go)[0],
            lt = po.core.getCache(at),
            ut = Zo(at),
            ct =
              "pinType" in e
                ? "fixed" === e.pinType
                : ut || "fixed" === Jo(at, "pinType"),
            ht = [e.onEnter, e.onLeave, e.onEnterBack, e.onLeaveBack],
            dt = ot && e.toggleActions.split(" "),
            ft = "markers" in e ? e.markers : za.markers,
            pt = ut ? 0 : parseFloat(ka(at)["border" + H.p2 + Ea]) || 0,
            Dt = this,
            gt =
              e.onRefreshInit &&
              function () {
            ...
            mt = (function (t, e, i) {
              var r = i.d,
                n = i.d2,
                s = i.a;
              return (s = Jo(t, "getBoundingClientRect"))
                ? function () {
                    return s()[r];
                  }
                : function () {
                    return (e ? go["inner" + n] : t["client" + n]) || 0;
                  };
            })(at, ut, H),
            vt = (function (t, e) {
              return !e || ~Ho.indexOf(t)
                ? ea(t)
                : function () {
                    return pl;
                  };
          ...
          (Dt.media = zo),
            ...
            (Dt.vars = e),
            (i = i || e.animation),
            "refreshPriority" in e && (Po = 1),
            (lt.tweenScroll = lt.tweenScroll || {
              top: vl(at, Aa),
              left: vl(at, Sa),
            }),
            (Dt.tweenTo = r = lt.tweenScroll[H.p]),
            i &&
              ((i.vars.lazy = !1),
              i._initted ||
            ...
            nt &&
              ...
              "scrollBehavior" in yo.style &&
                po.set(ut ? [yo, vo] : at, { scrollBehavior: "auto" }),
              (s = sa(nt.snapTo)
                ? nt.snapTo
                : "labels" === nt.snapTo
                ? (function (t) {
                    return function (e) {
                      return po.utils.snap(La(t), e);
                    };
                  })(i)
                ...
                : po.utils.snap(nt.snapTo)),
              (P = nt.duration || { min: 0.1, max: 2 }),
              (P = aa(P) ? Eo(P.min, P.max) : Eo(P, P)),
              (j = po
                .delayedCall(nt.delay || L / 2 || 0.1, function () {
                  if (Math.abs(Dt.getVelocity()) < 10 && !Ao) {
                      ...
                      r(
                        h,
                        {
                          ...
                          onInterrupt: function () {
                            return j.restart(!0) && p && p(Dt);
                          },
                          onComplete: function () {
                            (O = M =
                              i && !ot ? i.totalProgress() : Dt.progress),
                              it && it(Dt),
                              D && D(Dt);
                          },
                        },
                  ...
                  } else Dt.isActive && j.restart(!0);
                })
                .pause())),
            X && (Ya[X] = Dt),
            ($ = Dt.trigger = Co($ || Q)[0]),
            (Q = !0 === Q ? $ : Co(Q)[0]),
            na(Y) && (Y = { targets: $, className: Y }),
            Q &&
              (!1 === Z ||
                Z === Ca ||
                (Z = !(!Z && "flex" === ka(Q.parentNode).display) && xa),
              (Dt.pin = Q),
              !1 !== e.force3D && po.set(Q, { force3D: !0 }),
              (n = po.core.getCache(Q)).spacer
                ? (m = n.pinState)
                : ((n.spacer = _ = mo.createElement("div")),
                  _.setAttribute(
                    "class",
              ...
              (F = k[Z + H.os2]),
              (b = po.getProperty(Q)),
              (x = po.quickSetter(Q, H.a, Ta)),
              cl(Q, _, k),
              (y = fl(Q))),
            ft &&
              ((D = aa(ft) ? Oa(ft, qa) : qa),
              (f = Ha("scroller-start", X, at, H, D, 0)),
              (p = Ha("scroller-end", X, at, H, D, 0, f)),
              (w = f["offset" + H.op.d2]),
              (h = Ha("start", X, at, H, D, w)),
              (d = Ha("end", X, at, H, D, w)),
              ct ||
                (((V = ut ? yo : at).style.position =
                  "absolute" === ka(V).position ? "absolute" : "relative"),
                po.set([f, p], { force3D: !0 }),
                (S = po.quickSetter(f, H.a, Ta)),
                (A = po.quickSetter(p, H.a, Ta)))),
            (Dt.revert = function (t) {
              ...
              e !== o &&
                ...
                Q &&
                  (e
                    ? (function (t, e, i) {
                        if ((dl(i), t.parentNode === e)) {
                          var r = e.parentNode;
                          r && (r.insertBefore(t, e), r.removeChild(e));
                        }
                      })(Q, _, m)
                    : (!st || !Dt.isActive) && cl(Q, _, ka(Q), T)),
                (o = e));
            }),
            (Dt.refresh = function (r, n) {
              if ((!So && Dt.enabled) || n)
                if (Q && r && Xo) ja(t, "scrollEnd", Ja);
                else {
                  (So = 1),
                    B && B.pause(),
                  ...
                  for (
                    var s,
                      ...
                      Y = ($ && Math.max(0, Na.indexOf(Dt))) || 0,
                      X = Y;
                    X--;

                  )
                    (S = Na[X]).end || S.refresh(0, 1) || (So = 1),
                      (A = S.pin) && (A === $ || A === Q) && S.revert();
                  for (
                    u =
                      Dl(N, $, M, H, Dt.scroll(), h, f, Dt, L, pt, ct, P) ||
                      (Q ? -0.001 : 0),
                      sa(V) && (V = V(Dt)),
                      na(V) &&
                        !V.indexOf("+=") &&
                  ...
                  if (
                    ...
                    (c += j),
                    (Dt._pinPush = I),
                    h && j && (((s = {})[H.a] = "+=" + j), po.set([h, d], s)),
                    Q)
                  )
                    (s = ka(Q)),
                      (x = H === Aa),
                      (w = Dt.scroll()),
                      (C = parseFloat(b(H.a)) + I),
                      !P &&
                        c > 1 &&
                        ((ut ? yo : at).style["overflow-" + H.a] = "scroll"),
                      cl(Q, _, s),
                      (y = fl(Q)),
                      (D = Ma(Q, !0)),
                      (k = ct && ta(at, x ? Sa : Aa)()),
                      Z &&
                        (((T = [Z + H.os2, g + I + Ta]).t = _),
                        (X = Z === xa ? Ba(Q, H) + g + I : 0) &&
                          T.push(H.d, X + Ta),
                        dl(T),
                        ct && Dt.scroll(q)),
                      ct &&
                        (((F = {
                          top: D.top + (x ? w - u : k) + Ta,
                          left: D.left + (x ? k : w - u) + Ta,
                          boxSizing: "border-box",
                          position: "fixed",
                        }).width = F.maxWidth =
                          Math.ceil(D.width) + Ta),
                        (F.height = F.maxHeight = Math.ceil(D.height) + Ta),
                        (F.margin =
                          F.marginTop =
                          F.marginRight =
                          F.marginBottom =
                    ...
                    for (D = $.parentNode; D && D !== yo; )
                      D._pinOffset &&
                        ((u -= D._pinOffset), (c -= D._pinOffset)),
                        (D = D.parentNode);
                  for (X = 0; X < Y; X++)
                    (S = Na[X].pin) && (S === $ || S === Q) && Na[X].revert(!1);
                  (Dt.start = u),
                    (Dt.end = c),
            ...
            (Dt.getVelocity = function () {
              return ((Dt.scroll() - l) / (No() - Fo)) * 1e3 || 0;
            }),
            (Dt.update = function (t, e) {
              ...
              if (
                ...
                if (
                  ...
                  ot ||
                    (!B || So || Vo
                      ? i && i.totalProgress(m, !!So)
                      : ((B.vars.totalProgress = m), B.invalidate().restart())),
                  Q)
                )
                  if ((t && Z && (_.style[Z + H.os2] = F), ct)) {
                    if (h) {
                      if (
                        ((o = !t && m > w && c + 1 > p && p + 1 >= ia(at, H)),
                        st)
                      )
                        if (t || (!n && !o)) ml(Q, _);
                        else {
                ...
                nt && !r.tween && !So && !Vo && j.restart(!0),
                  Y &&
                    (d || (rt && m && (m < 1 || !qo))) &&
                    Co(Y.targets).forEach(function (t) {
            ...
            (Dt.disable = function (e, i) {
              if (
                ...
                (q = 0),
                n && (n.uncache = 1),
                gt && Ra(t, "refreshInit", gt),
                j && (j.pause(), r.tween && r.tween.kill() && (r.tween = 0)),
                !ut)
              ) {
                for (var s = Na.length; s--; )
                  if (Na[s].scroller === at && Na[s] !== Dt) return;
                Ra(at, "resize", Ua), Ra(at, "scroll", Ga);
              }
            }),
            (Dt.kill = function (t, e) {
              Dt.disable(t, e), X && delete Ya[X];
              var r = Na.indexOf(Dt);
              Na.splice(r, 1),
                r === Oo && ol > 0 && Oo--,
                i &&
      ...
      (t.register = function (e) {
        if (
          ...
          $o() &&
            ...
            ((go = window),
            (mo = document),
            (vo = mo.documentElement),
            (yo = mo.body)),
          po &&
            ((Co = po.utils.toArray),
            (Eo = po.utils.clamp),
            (jo = po.core.suppressOverwrites || Uo),
            po.core.globals("ScrollTrigger", t),
            yo))
        ) {
          (bo =
          ...
          (r.borderTop = "1px solid #000"),
            (i = Ma(yo)),
            (Aa.m = Math.round(i.top + Aa.sc()) || 0),
            (Sa.m = Math.round(i.left + Sa.sc()) || 0),
            n ? (r.borderTop = n) : r.removeProperty("border-top"),
            (To = setInterval(Xa, 200)),
            po.delayedCall(0.5, function () {
              return (Vo = 0);
            }),
            ja(mo, "touchcancel", Uo),
            ja(yo, "touchstart", Uo),
            Pa(ja, mo, "pointerdown,touchstart,mousedown", function () {
              return (Ao = 1);
            }),
            Pa(ja, mo, "pointerup,touchend,mouseup", function () {
              return (Ao = 0);
            }),
            (ko = po.utils.checkPrefix("transform")),
            ul.push(ko),
            (Do = No()),
            (wo = po.delayedCall(0.2, nl).pause()),
            (Lo = [
              mo,
              "visibilitychange",
              function () {
      ...
      (t.defaults = function (t) {
        for (var e in t) za[e] = t[e];
      }),
      (t.kill = function () {
        (Go = 0),
          Na.slice(0).forEach(function (t) {
            return t.kill(1);
          });
      }),
      (t.config = function (t) {
        "limitCallbacks" in t && (qo = !!t.limitCallbacks);
        var e = t.syncInterval;
        (e && clearInterval(To)) || ((To = e) && setInterval(Xa, e)),
          "autoRefreshEvents" in t &&
            (ra(Ra) || ra(ja, t.autoRefreshEvents || "none"),
      ...
      (t.scrollerProxy = function (t, e) {
        var i = Co(t)[0],
          ...
          n = Zo(i);
        ~r && Wo.splice(r, n ? 6 : 2),
          n ? Ho.unshift(go, e, yo, e, vo, e) : Ho.unshift(i, e);
      }),
              ...
              : (e = go.matchMedia(i)) &&
                ...
                ~r
                  ...
                  : ((r = Qa.length),
                    ...
                    e.addListener
                      ? e.addListener(Za)
                      : e.addEventListener("change", Za)),
                (Qa[r + 3] = e.matches)),
            (zo = 0);
        return Qa;
      }),
      (t.clearMatchMedia = function (t) {
        t || (Qa.length = 0), (t = Qa.indexOf(t)) >= 0 && Qa.splice(t, 4);
      }),
      t
    );
  })();
  (yl.version = "3.6.1"),
    (yl.saveStyles = function (t) {
      return t
        ? Co(t).forEach(function (t) {
            if (t && t.style) {
              var e = el.indexOf(t);
              e >= 0 && el.splice(e, 4),
                el.push(t, t.style.cssText, po.core.getCache(t), zo);
            }
          })
        : el;
    }),
    (yl.revert = function (t, e) {
      return rl(!t, e);
    }),
    (yl.create = function (t, e) {
      return new yl(t, e);
    }),
    (yl.refresh = function (t) {
      return t ? Ua() : nl(!0);
    }),
    (yl.update = al),
    (yl.maxScroll = function (t, e) {
      return ia(t, e ? Sa : Aa);
    }),
    (yl.getScrollFunc = function (t, e) {
      return ta(Co(t)[0], e ? Sa : Aa);
    }),
    (yl.getById = function (t) {
      return Ya[t];
    }),
    (yl.getAll = function () {
      return Na.slice(0);
    }),
    (yl.isScrolling = function () {
      return !!Xo;
    }),
    (yl.addEventListener = function (t, e) {
      var i = Ka[t] || (Ka[t] = []);
      ~i.indexOf(e) || i.push(e);
    }),
    (yl.removeEventListener = function (t, e) {
      var i = Ka[t],
        r = i && i.indexOf(e);
      r >= 0 && i.splice(r, 1);
    }),
    (yl.batch = function (t, e) {
      var i,
        r = [],
        n = {},
        s = e.interval || 0.016,
      ...
      for (i in e)
        n[i] =
          "on" === i.substr(0, 2) && sa(e[i]) && "onRefreshInit" !== i
            ? a(0, e[i])
            : e[i];
      return (
        sa(o) &&
          ((o = o()),
          ja(yl, "refresh", function () {
            return (o = e.batchMax());
          })),
        Co(t).forEach(function (t) {
          var e = {};
          for (i in n) e[i] = n[i];
          (e.trigger = t), r.push(yl.create(e));
        }),
        r
      );
    }),
    ...
    Qo() && po.registerPlugin(yl);
  class _l extends bt.Renderer {
    onEnter() {
      console.log("I am home render"),
        es.registerPlugin(Vs),
        es.registerPlugin(yl),
      ...
      if (
        ((window.onload = () => {
          ...
          console.log("I am working"),
            ...
            es
              .timeline({ delay: 0.6, defaults: { ease: ws } })
              .from(
                ".js-hero-title .line-child",
        ...
        ft.on("scroll", yl.update),
        yl.scrollerProxy("#js-scroll", {
          scrollTop: function (t) {
            return arguments.length
              ? ft.scrollTo(t, 0, 0)
              : ft.scroll.instance.scroll.y;
          },
        ...
        es.utils.toArray(".js-reveal").forEach((t) => {
          es.from(t.querySelectorAll(".line-child"), {
        ...
        es.utils.toArray(".c-honors__list").forEach((t) => {
          es.from(t.querySelectorAll(".c-honors__list .js-reveal > span"), {
            scrollTrigger: {
              trigger: t,
              scroller: "#js-scroll",
              start: "10 center",
        ...
        es.utils.toArray(".c-honors__list").forEach((t) => {
          es.from(t.querySelectorAll(".c-honors__list li a"), {
            scrollTrigger: {
              trigger: t,
              scroller: "#js-scroll",
              start: "10 center",
      ...
      es.from(".js-line-1", {
        ...
        yl.addEventListener("refresh", () => ft.update()),
        yl.refresh();
      var r = [
      ...
      n.forEach((t, e) => {
        ...
        document
          ...
          .addEventListener("mousemove", (t) => {
            es.to(s, { x: t.clientX - 18, y: t.clientY - 10, duration: 0.5 });
          }),
  ...
  class wl extends bt.Renderer {
    onEnter() {
      ...
      console.log("I am Play render"),
        window.matchMedia("(max-width: 900px)").matches &&
          (window.scrollTo(0, 0), console.log("mathc")),
        document.querySelectorAll(".js-year").forEach((t) => {
          t.innerHTML = "©" + new Date().getFullYear();
        }),
        es.registerPlugin(yl),
        setTimeout(() => {
          yl.refresh(), console.log("called");
        }, 2e3),
        document.querySelector("#contact_btn").addEventListener("click", () => {
          pt.open(),
            1 == pt.first &&
              ...
              (pt.first = !1)),
            console.log("i attached the even to play button");
        }),
        yl.create({
          trigger: "footer",
          scroller: "#js-scroll",
  ...
  new bt.Core({
    renderers: { home: _l, play: wl },
    transitions: { home: Hs, play: Ws },
  }).on("NAVIGATE_END", () => {
    ft.start(), ft.update();
  });
  new fo(".js-split", { type: "lines", linesClass: "line-parent" }),
    new fo(".js-split > .line-parent", {
      type: "lines",
  ...
  (window.onload = () => {
    ...
    pt.send.addEventListener("click", function (t) {
      pt.next_query();
    });
  const bl = document.querySelectorAll("#js-slider > div label"),
    xl = document.querySelectorAll("#js-slider .s-text input");
  for (let t of bl)
  ...
  const Cl = document.querySelector("#contact");
  Cl.addEventListener("submit", (t) => {
    t.preventDefault(),
      fetch(
        "https://script.google.com/macros/s/AKfycbyz3mXuTC1SSl5t68_I7obpgg1AKIPc4rPE_icB5JrI8KaIaG-f/exec",
        { method: "POST", body: new FormData(Cl) }
      )
        .then((t) => console.log("Success!", t))
        .catch((t) => console.error("Error!", t.message));
  }),
    console.log("Designed and Developed by HASNAIN 可汗.");
})();
//# sourceMappingURL=playbook.a2882545.js.map
